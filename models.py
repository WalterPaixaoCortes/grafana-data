...
class ImdbMovies(Base):
    ...
    pais = Column(String(4000), nullable=True)
    lingua = Column(String(4000), nullable=True)
    diretor = Column(String(4000), nullable=True)
    escritor = Column(String(4000), nullable=True)
    empresa_produtora = Column(String(200), nullable=True)
    atores = Column(String(4000), nullable=True)
    descricao = Column(String(4000), nullable=True)
